        ...
        <column header="Торговая площадка" headerStyle="width: 30%">
          <template #body="slopProps">
            <div class="w-full flex flex-row align-items-center">
              <img
                :src="require('@/assets' + slopProps.data.image)"
...
export default defineComponent({
  setup() {
    ...
    const items: {
      ...
      {
        image: '/images/ozon.svg',
        name: 'Ozon',
        itemsCount: 234,
        lastLoaded: new Date('2022-12-13T13:12:00Z'),
        ordersCount: 43,
        lastUploaded: new Date('2022-12-13T13:49:00Z'),
        active: true,
      },
      {
        ...
        name: 'Яндекс Маркет',
        itemsCount: 12,
        lastLoaded: new Date('2022-12-14T12:43:00Z'),
        ordersCount: 4,
        lastUploaded: new Date('2022-12-15T13:54:00Z'),
        active: true,
      },
      {
        image: '/images/avito.svg',
        name: 'Avito',
        itemsCount: 76,
        lastLoaded: new Date('2022-12-16T15:00:00Z'),
        ordersCount: 18,
        lastUploaded: new Date('2022-12-19T14:12:00Z'),
        active: false,
      },
    ];
